        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16 text-left">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              <Link to="/contact"
                className={`text-center px-7 py-4 border font-semibold text-sm rounded-xl transition-all duration-200 ${
                  light
              ...
              {useOfFunds.map((f) => (
                <div key={f.label}>
                  <div className="mb-1.5 flex items-baseline justify-between gap-3">
                    ...
                    <span className="text-sm font-black text-green-500">{f.pct}%</span>
                  </div>
